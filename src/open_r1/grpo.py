...
import numpy as np
numpy_globals = [
    _reconstruct,           # numpy array reconstruction
    np.ndarray,            # numpy arrays
    np.dtype,              # numpy data types
    np.core.multiarray.scalar,  # numpy scalars
]

# Add numpy dtypes for different precisions
numpy_globals.extend([
...
torch.serialization.add_safe_globals(numpy_globals)
...
def main(script_args, training_args, model_args):
    ...
    def make_conversation(example):
        prompt_column = "prompt" if "prompt" in example else "problem"
        prompt = []
