...
class GRPOConfig(TrainingArguments):
    ...
    use_ours: bool = field(
        default=False,
        metadata={
            "help": "Whether to use our implementation of GRPO. If set to `True`, the training will use our custom "
        },
    )
    epsilon_low: Optional[float] = field(
        default=None,
        metadata={
            "help": "Lower-bound epsilon value for clipping. If not specified, it defaults to the same value as the "
        },
    )
